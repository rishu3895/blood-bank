...
<nav class="navbar navbar-light bg-light">
    <div class="container-fluid">
        ...
        <form class="d-flex nav-bar-btn-class" >
            ...
            <button type="button" class="btn btn-primary nav-btn show-all-blood-bank-btn" id="show-blood-bank-data-btn">
                All Blood Banks data 
            </button>
            <button type="button" class="btn btn-primary nav-btn home-btn" onclick="moveToHome()">
                Home
            </button>
            <button type="button" class="btn btn-primary nav-btn log-out-btn" onclick="logOut()" >
                Log Out
            </button>
        </form>
    </div>
